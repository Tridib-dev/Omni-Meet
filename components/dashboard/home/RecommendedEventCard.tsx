...
export function RecommendedEventCard({ event, index }: Props) {
    ...
    return (
        <motion.article
            ...
            className="group relative h-full space-y-4 sm:space-y-5"
        >
            <Link
            ...
            <div className="w-full rounded-[24px] border border-white/10 bg-[linear-gradient(180deg,rgba(7,9,15,0.18),rgba(7,9,15,0.88))] px-4 py-4 backdrop-blur-md sm:px-5 sm:py-5 lg:px-6 lg:py-6">
                <div className="grid gap-4 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,0.7fr)] lg:items-end">
                    <div className="space-y-3">
                        <h3 className="max-w-2xl text-[26px] font-semibold leading-[1.04] tracking-[-0.04em] text-white sm:text-[34px] lg:text-[42px]">
                            {event.title}
                        </h3>
                        <p className="max-w-2xl text-[13px] leading-relaxed text-white/82 sm:text-[14px] lg:text-[15px]">
