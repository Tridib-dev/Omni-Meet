...
export function EventBannerContent({ event, compact = false }: Props) {
    ...
    return (
        ...
        <div className="absolute bottom-0 left-0 right-0 z-10 bg-gradient-to-t from-black/80 via-black/50 to-transparent py-3 sm:py-4 lg:py-5 px-3 sm:px-4 lg:px-6">
            <div className="flex items-end justify-between gap-4">
                ...
                <div className="flex flex-col gap-1.5 text-right">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3 justify-end text-slate-200">
