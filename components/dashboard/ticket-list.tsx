            ...
            <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-3 mb-1.5">
                    <Link
                        ...
                        className="text-[14px] font-medium text-white/90 hover:text-cyan-400 transition-colors line-clamp-1 leading-snug"
                    >
                        {ticket.eventTitle}
                    </Link>
                    ...
                    {/* Status chip */}
                    <span
                        className="flex-shrink-0 flex items-center gap-1.5 text-[11px] font-medium px-2 py-0.5 rounded-full"
                        style={{
