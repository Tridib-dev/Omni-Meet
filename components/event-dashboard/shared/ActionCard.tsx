    ...
    return (
        ...
        >
            <Link
                ...
                className="flex min-h-[104px] min-w-[220px] flex-col justify-between rounded-xl border border-white/8 bg-white/[0.03] p-4 transition-colors hover:border-[#332be0]/30 hover:bg-[#332be0]/8 sm:p-5"
            >
                <div>
