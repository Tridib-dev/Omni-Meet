    ...
    return (
        <div>
            ...
            <p className="text-[14px] text-white/40 mb-2">
                Bring DevEvent into the apps you already use.
            </p>
            <p className="text-[12px] text-white/25 mb-8">
                These integrations are optional — you can set them up anytime from Settings.
            </p>
                ...
                {TOOLS.map((tool) => (
                    ...
                    >
                        <div
                            ...
                            style={{ background: `${tool.color}22`, color: tool.color === "#000000" ? "white" : tool.color }}
                        >
                            {tool.icon}
                        </div>
                        <div className="flex-1 min-w-0">
                            <p className="text-[13px] font-semibold text-white/85">{tool.name}</p>
            ...
            <div className="flex gap-3">
                ...
                <button
                    onClick={() => router.push("/onboarding/connect-ads")}
