...
export default function GateNotFound() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#0A0C10] px-6 text-white">
      <div className="w-full max-w-md rounded-3xl border border-white/10 bg-white/5 p-8 text-center">
        ...
        <p className="text-xs uppercase tracking-[0.3em] text-cyan-300/80">Gate not found</p>
        <h1 className="mt-3 text-3xl font-semibold">This event gate does not exist.</h1>
        <p className="mt-3 text-sm leading-6 text-white/65">
          The event may be missing, unpublished, or the gate URL may be wrong.
        </p>
        <Link
          href="/"
